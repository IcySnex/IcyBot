...
public class Log
{
    ...
    public static void Error(string Message, ConsoleColor Color = ConsoleColor.White, [CallerFilePath] string Caller = "", [CallerMemberName] string Method = "") =>
        Invoke(Caller, new(Message, Color, LogType.Error, ConsoleColor.Red, Method));
